...
export const metadata: Metadata = {
  ...
  description: 'Khám phá các giải pháp đầu tư toàn diện và chuyên nghiệp tại Y&T Capital. Kiến thức đầu tư, chiến lược và quản lý rủi ro.',
  keywords: [
    'giải pháp đầu tư',
    'kiến thức đầu tư',
    'chiến lược đầu tư',
  ...
  openGraph: {
    title: 'Giải pháp Đầu tư - Y&T Capital',
