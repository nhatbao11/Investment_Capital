# Design System - Y&T Capital

## Tổng quan
Design system này cung cấp một bộ quy tắc thống nhất cho việc thiết kế giao diện của Y&T Capital, bao gồm màu sắc, typography, spacing, và các component cơ bản.
