    ...
    <footer className="relative bg-gradient-to-br from-gray-50 via-white to-blue-50 text-black border-t border-gray-200 font-sans mt-0 sm:mt-0 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 py-8 sm:py-12 lg:py-16">
        <div className="flex flex-col lg:flex-row justify-between items-start gap-8 lg:gap-12 xl:gap-16">
          ...
          <motion.div
            className="flex flex-col items-center text-center w-full lg:w-auto lg:mt-10"
          ...
          >
            ...
            <motion.p
              className="text-blue-900 text-xs sm:text-sm lg:text-base font-bold text-center max-w-xs"
      ...
      {/* Social Media */}
      <div className="relative border-t border-gray-200 mt-4 sm:mt-6 pt-4 sm:pt-6">
          ...
          <div className="flex flex-col items-center space-y-3 sm:space-y-4">
            ...
            >
              <p className="text-xs sm:text-sm text-gray-600 font-medium">
                © 2025 <span className="text-blue-900 font-bold">Y&T Capital</span>. {t("footer.rights")}
              </p>
            </motion.div>
          </div>
        </div>
