                ...
                {items.map((b) => (
                  <tr key={b.id}>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-gray-900 max-w-xs truncate">{b.title}</div>
                      {b.description && <div className="text-sm text-gray-500 max-w-xs truncate">{b.description}</div>}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      {b.image_url ? (
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{b.view_count}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{b.download_count}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{b.author_name || 'Admin'}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{new Date(b.created_at).toLocaleDateString('vi-VN')}</td>
